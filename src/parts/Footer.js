                ...
                <div className="row">
                    ...
                    <div className="col-auto mr-5">
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item">
                                <Button type="link" href="/properties">Start Book a Room</Button>
                            </li>
                            <li className="list-group-item">
                    ...
                    <div className="col-2 mr-5">
                        ...
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item">
                                <Button type="link" href="/terms">Terms & Condisitions</Button>
                            </li>
                        </ul>
                    </div>
                    <div className="col-3">
                        ...
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                                <Button isExternal type="link" href="mailto:support@staycation.ic">support@staycation.id</Button>
                            </li>
                            <li className="list-group-item">
                                <Button isExternal type="link" href="tel:+622134455676">02134455676</Button>
                            </li>
                            <li className="list-group-item">
